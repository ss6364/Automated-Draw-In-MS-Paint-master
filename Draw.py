#-----------------------------------------------------------------------------
#Author: Shivansh Shukla(github.com/shivanshshukla)
...
p,q = int(0.10*screenwidth),int(0.10*screenheight)
...
def openPaint():
    ...
    pyautogui.typewrite('\n') #pressing Enter Key to open Window
    #pyautogui.press('OK') 
    """
    coordinates = pyautogui.locateOnScreen('Icon.png')
    i = 1
